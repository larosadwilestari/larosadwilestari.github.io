...
<?php include "header.php";?>
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <form enctype="multipart/form-data"  action="proses-input-siswa.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="guru_id" value="<?php echo $row['siswa_id']?>" class="form-control">
